declare module 'preact-redux' {
  import { AnyComponent, Component, ComponentConstructor, ComponentProps, VNode, render } from 'preact';
  ...
  export interface ProviderProps extends ComponentProps<Provider> {
      /**
